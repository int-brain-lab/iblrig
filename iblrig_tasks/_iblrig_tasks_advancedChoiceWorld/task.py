...
class Session(ActiveChoiceWorldSession):
    ...
    def extra_parser():
        ...
        parser.add_argument('--contrast_set', option_strings=['--contrast_set'],
                            dest='contrast_set', default=DEFAULTS["CONTRAST_SET"], nargs='+',
                            type=float, help='set of contrasts to present')
