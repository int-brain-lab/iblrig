...
class Session(TrainingChoiceWorldSession):
    """Training Choice World using the pre-8.23.4 zero-contrast convention.

    This variant reproduces the TrainingChoiceWorld behaviour as it was implemented in IBLRIG versions 8.10.0 - 8.23.3.
    It is identical to the standard :class:`~iblrig.base_choice_world.TrainingChoiceWorldSession` in every respect except for the
    handling of zero-contrast trials.
