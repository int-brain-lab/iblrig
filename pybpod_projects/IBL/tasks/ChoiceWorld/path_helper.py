...
class SessionPathCreator(object):
    ...
    def get_bonsai_path(self, _use_ibl_bonsai):
        ...
        if _use_ibl_bonsai == True:
            BONSAI = ibl_bonsai
        elif _use_ibl_bonsai == False and preexisting_bonsai.exists():
            BONSAI = str(preexisting_bonsai)
        elif _use_ibl_bonsai == False and not preexisting_bonsai.exists():
