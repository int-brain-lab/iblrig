...
def get_reading(bpod_instance, save_to=None):
    ambient_module = [x for x in bpod_instance.modules if x.name == "AmbientModule1"][0]
    ...
    if save_to is not None:
        ...
        with open(os.path.join(save_to, "_iblrig_ambientSensorData.raw.jsonable"), "a") as f:
