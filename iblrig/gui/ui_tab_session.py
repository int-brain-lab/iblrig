...
class Ui_tabSession(object):
    ...
    def retranslateUi(self, tabSession):
        ...
        self.uiComboUser.setToolTip(_translate("tabSession", "Enter or select your Alyx username"))
        self.uiPushConnect.setToolTip(_translate("tabSession", "Connect to Alyx"))
        self.uiPushConnect.setText(_translate("tabSession", "Connect"))
        self.label_2.setText(_translate("tabSession", "Subject"))
        self.uiComboSubject.setToolTip(_translate("tabSession", "Choose a subject"))
        self.lineEditSubject.setToolTip(_translate("tabSession", "Filter displayed subjects by name"))
        self.lineEditSubject.setPlaceholderText(_translate("tabSession", "Filter"))
        self.label_4.setText(_translate("tabSession", "Task"))
        self.uiComboTask.setToolTip(_translate("tabSession", "Choose a task for the session"))
        self.label_3.setText(_translate("tabSession", "Project"))
        self.uiListProjects.setToolTip(_translate("tabSession", "Select one or several projects for the session (mandatory)"))
        self.label_5.setText(_translate("tabSession", "Procedure"))
        self.uiListProcedures.setToolTip(_translate("tabSession", "Select one or several procedures for the session (mandatory)"))
        ...
        self.uiPushPause.setToolTip(_translate("tabSession", "Pause the session after the current trial"))
        self.uiPushPause.setText(_translate("tabSession", "Pause"))
        self.uiPushStart.setToolTip(_translate("tabSession", "Start the session"))
        self.uiPushStart.setText(_translate("tabSession", "Start"))
        self.uiCheckAppend.setToolTip(_translate("tabSession", "Append to previous session"))
        self.uiCheckAppend.setText(_translate("tabSession", "Append"))
        self.uiGroupTools.setTitle(_translate("tabSession", "Tools"))
        self.uiPushFlush.setToolTip(_translate("tabSession", "Flush the valve"))
        self.uiPushFlush.setText(_translate("tabSession", " Flush Valve"))
        self.uiPushHelp.setToolTip(_translate("tabSession", "Open the iblrig documentation in your browser"))
        self.uiPushHelp.setText(_translate("tabSession", "  Help!"))
        self.uiPushStatusLED.setToolTip(_translate("tabSession", "Toggle the Bpod Status LED (always off during sessions)"))
