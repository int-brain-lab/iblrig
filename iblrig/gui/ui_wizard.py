...
class Ui_wizard(object):
    def setupUi(self, wizard):
        ...
        self.uiPlainTextEditLog.setStyleSheet("background-color: rgb(36, 31, 49);")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/images/log"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tabLog, icon4, "")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/images/previous"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.uiPushWebBack.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/images/next"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.uiPushWebForward.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/images/home"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.uiPushWebHome.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/images/globe"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.uiPushWebBrowser.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/images/help"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tabDocumentation, icon9, "")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/images/github"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.commandLinkButtonGitHub.setIcon(icon10)
        ...
        self.commandLinkButtonDoc.setIcon(icon9)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/images/bug"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.commandLinkButtonIssues.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/images/discussion"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.commandLinkButtonDiscussion.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/images/about"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tabAbout, icon13, "")
