...
class Ui_wizard(object):
    def setupUi(self, wizard):
        ...
        self.menuSettings = QtWidgets.QMenu(self.uiMenuBar)
        ...
        self.uiActionGuiSettings = QtWidgets.QAction(wizard)
        self.uiActionGuiSettings.setObjectName("uiActionGuiSettings")
        ...
        self.menuSettings.addAction(self.uiActionGuiSettings)
        self.uiMenuBar.addAction(self.uiMenuTools.menuAction())
        self.uiMenuBar.addAction(self.menuSettings.menuAction())
    ...
    def retranslateUi(self, wizard):
        ...
        self.uiLineEditUser.setToolTip(_translate("wizard", "Enter your user name"))
        self.uiLineEditUser.setPlaceholderText(_translate("wizard", "not logged in"))
        self.uiPushButtonLogIn.setToolTip(_translate("wizard", "Log user into Alyx"))
        self.uiPushButtonLogIn.setText(_translate("wizard", "Log In"))
        self.labelSubject.setText(_translate("wizard", "&Subject"))
        self.uiComboSubject.setToolTip(_translate("wizard", "Choose a subject"))
        self.lineEditSubject.setToolTip(_translate("wizard", "Filter subjects by name"))
        self.lineEditSubject.setPlaceholderText(_translate("wizard", "Filter"))
        self.labelProject.setText(_translate("wizard", "&Project"))
        self.uiListProjects.setToolTip(_translate("wizard", "Select one or several projects"))
        self.labelProcedure.setText(_translate("wizard", "P&rocedures"))
        self.uiListProcedures.setToolTip(_translate("wizard", "Select one or several procedures"))
        self.listViewRemoteDevices.setToolTip(_translate("wizard", "Select remote devices"))
        self.uiComboTask.setToolTip(_translate("wizard", "Select a task for the session"))
...
"&Devices"))
        ...
        self.uiPushFlush.setToolTip(_translate("wizard", "Flush the Bpod\'s valve"))
        self.uiPushFlush.setText(_translate("wizard", " &Flush Valve  "))
        self.uiPushReward.setToolTip(_translate("wizard", "Grant a free reward"))
        self.uiPushReward.setText(_translate("wizard", " Fr&ee Reward"))
        self.uiPushStatusLED.setToolTip(_translate("wizard", "Toggle the Bpod\'s status LED"))
        ...
        self.uiPushStart.setToolTip(_translate("wizard", "Start the session"))
        self.uiPushStart.setText(_translate("wizard", "Start"))
        self.uiPushPause.setToolTip(_translate("wizard", "Pause the session after the current trial"))
        ...
        self.menuSettings.setTitle(_translate("wizard", "Settings"))
        ...
        self.uiActionGuiSettings.setText(_translate("wizard", "GUI Settings"))
