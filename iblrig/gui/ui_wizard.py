...
class Ui_wizard(object):
    def setupUi(self, wizard):
        ...
        self.uiGroupRemoteDevices = QtWidgets.QGroupBox(self.widget_3)
        self.uiGroupRemoteDevices.setObjectName("uiGroupRemoteDevices")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.uiGroupRemoteDevices)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.listViewRemoteDevices = QtWidgets.QListView(self.uiGroupRemoteDevices)
        ...
        self.verticalLayout_2.addWidget(self.listViewRemoteDevices)
        self.pushButtonUpdateRemoteDevices = QtWidgets.QPushButton(self.uiGroupRemoteDevices)
        self.pushButtonUpdateRemoteDevices.setObjectName("pushButtonUpdateRemoteDevices")
        self.verticalLayout_2.addWidget(self.pushButtonUpdateRemoteDevices)
        self.horizontalLayout_8.addWidget(self.uiGroupRemoteDevices)
    ...
    def retranslateUi(self, wizard):
        ...
        self.uiGroupRemoteDevices.setTitle(_translate("wizard", "Remote Devices"))
        self.pushButtonUpdateRemoteDevices.setText(_translate("wizard", "Update Status"))
