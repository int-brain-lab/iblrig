...
class Ui_TabData(object):
    ...
    def retranslateUi(self, TabData):
        ...
        self.tableView.setToolTip(_translate("TabData", "Double-click a row to open the respective folder"))
        self.lineEditFilter.setToolTip(_translate("TabData", "Filter table by subject"))
        self.lineEditFilter.setPlaceholderText(_translate("TabData", "Filter by Subject"))
        self.pushButtonUpdate.setToolTip(_translate("TabData", "Update table"))
