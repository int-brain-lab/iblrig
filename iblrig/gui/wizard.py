...
from iblrig.gui.models import RigWizardModel
import iblrig.hardware_validation
import iblrig.path_helper
from iblrig.base_tasks import EmptySession
from iblrig.choiceworld import training_phase_from_contrast_set
...
class CustomWebEnginePage(QtWebEngineWidgets.QWebEnginePage):
    ...
    def acceptNavigationRequest(
            self, url: QtCore.QUrl, navigation_type: QtWebEngineWidgets.QWebEnginePage.NavigationType, is_main_frame: bool):
        """
        ...
        """
        if navigation_type == QtWebEngineWidgets.QWebEnginePage.NavigationTypeLinkClicked and not url.url().startswith(URL_DOC):
