...
def get_subject_training_info(
    ...
    **kwargs
        Optional arguments to be passed to iterate_previous_sessions
    ...
    prev_reward_vol = session_info.task_settings.get('ADAPTIVE_REWARD_AMOUNT_UL') or session_info.task_settings.get(
        'REWARD_AMOUNT_UL'
    )
